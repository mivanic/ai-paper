...
: Real factor price changes as a result of implementing a technology to substitute clerical labor on par with no-unemployment assumption for all labor (wages adjust)
...
: Real commodity price changes as a result of implementing a technology to substitute clerical labor on par with no-unemployment assumption for all labor (wages adjust)
