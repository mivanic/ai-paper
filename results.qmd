...
![EV (percentage of original expenditure) as a result of implementing a technology that allows for replacement of clerical labor with AI on par for both labor assumptions](assets/figure-scenario-1a-1b-ev.png){#fig-scenario1-equivalent-variation}
