...
![EV (percentage of original expenditure) as a result of implementing a technology that allows for replacement of clerical labor with AI on par for three labor assumptions](assets/figure-scenario-1a-1b-1c-ev.png){#fig-scenario1-equivalent-variation}
...
![Change in qauntity of clerical labor as a result of implementing a technology that allows for replacement of clerical labor with AI on par with unemployment assumption for clerical labor (fixed clerical nominal wages)](assets/figure-scenario-1b-qe-clerks.png){#fig-scenario1b-quantity-qe-clerks}