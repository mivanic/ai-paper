...
model, as implemented by \citet{ivanic2025}. This model represents all
key markets, i.e., production, input demand, factor incomes,
consumption, trade and savings, in a global general equilibrium setting
under the assumption of zero economic profits and constant returns to
scale. Production is represented as a nested CES production function
that combines factors into a value-added composite and intermediate
inputs into an intermediate input composite at the bottom level. They
are then combined into the final output at the top level.
...
\pandocbounded{\includegraphics[keepaspectratio]{figure-ev-unemployemt.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figure-ev-nounemployemt.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{ev-dec-world_unemployment.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{ev-dec-world_nounemployment.png}}
...
service when when firms use it to replace labor. We consider different
rates of tax ranging from 0 to 100 percent. In
Figure~\ref{fig-equivalent-variation-tax} we show the impact of the tax
on global welfare. The figure suggests that with a tax rate of 95\% all
adoption of AI ceases. The exact impact of the tax on AI adoption and
welfare depends on the whether the displaced clerical labor stays in the
market; in this case, increasing the tax rate on AI from 0 to 100
percent would almost linearly reduce its benefits to the global economy.
On the other hand, if clerical labor exits the labor market, a tax rate
below 35 percent would have only a small impact on the associated
welfare loss; to prevent a substantial portion of such a loss would
require a tax rate of 50\% or more.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{figure-tax-ev-both.png}}
...
previously, this innovation seems that it will affect higher
skilled/wages more than unskilled labor. But, like all the others,
capital is key and the gains seem like they will accrue to those with
the means to procure the innovation.
...
and can change in the future. Our work operatlizes AI within a common
CGE, future work could also consider the productivity interaction, or
consider AI being introduced to developing countries at a lower rate
